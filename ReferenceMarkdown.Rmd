...
<br> <!-- salt de linia com HTML -->

//Escriure INTRO


<!-- WARNING: data must have been properly declared before (factors, dates...) creating the CSV -->

```{r, echo=FALSE}
#READ TABLE

setwd(dirname(rstudioapi::getActiveDocumentContext()$path)) #path al dicteroy del script
dd <- read.csv("Accidents5000Reduit.csv")                   #revisar si s'ha de canviar el nom per un altre .CSV
